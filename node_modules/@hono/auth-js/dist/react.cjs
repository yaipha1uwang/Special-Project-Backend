...
let __auth_core_errors = require("@auth/core/errors");
__auth_core_errors = require_chunk.__toESM(__auth_core_errors);

//#region src/client.ts
var ClientFetchError = class extends __auth_core_errors.AuthError {};
var ClientSessionError = class extends __auth_core_errors.AuthError {};
...
function useOnline() {
	const [isOnline, setIsOnline] = (0, react.useState)(typeof navigator !== "undefined" ? navigator.onLine : false);
	(0, react.useEffect)(() => {
...
function useSession(options) {
	...
	const session = (0, react.useContext)(SessionContext);
...
const useOauthPopupLogin = (provider, options = {}) => {
	...
	const [externalWindow, setExternalWindow] = (0, react.useState)();
	const [state, setState] = (0, react.useState)({ status: "loading" });
	const popUpSignin = (0, react.useCallback)(async () => {
...
exports.authConfigManager = authConfigManager;
exports.getCsrfToken = getCsrfToken;
exports.getProviders = getProviders;
exports.getSession = getSession;
exports.signIn = signIn;
exports.signOut = signOut;
exports.useOauthPopupLogin = useOauthPopupLogin;
